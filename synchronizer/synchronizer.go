...
func (s *ClientSynchronizer) IsSynced() bool {
	return s.synced
}
	...
	for i := range blocks {
		...
		for _, element := range order[blocks[i].BlockHash] {
			...
			case etherman.DepositsOrder:
				log.Debug("Event received. DepositsOrder ignored...")

			case etherman.ClaimsOrder:
				log.Debug("Event received. ClaimsOrder ignored...")
			case etherman.TokensOrder:
				log.Debug("Event received. TokensOrder ignored...")
