...
func (_m *ReorgManager) CheckReorg(latestBlock *entities.L1Block, syncedBlock *types.Block) (*entities.L1Block, uint64, error) {
	...
	var r1 uint64
	var r2 error
	if rf, ok := ret.Get(0).(func(*entities.L1Block, *types.Block) (*entities.L1Block, uint64, error)); ok {
		return rf(latestBlock, syncedBlock)
	}
	if rf, ok := ret.Get(0).(func(*entities.L1Block, *types.Block) *entities.L1Block); ok {
	...
	if rf, ok := ret.Get(1).(func(*entities.L1Block, *types.Block) uint64); ok {
		r1 = rf(latestBlock, syncedBlock)
	} else {
		r1 = ret.Get(1).(uint64)
	}

	if rf, ok := ret.Get(2).(func(*entities.L1Block, *types.Block) error); ok {
...
func (_c *ReorgManager_CheckReorg_Call) Run(run func(latestBlock *entities.L1Block, syncedBlock *types.Block)) *ReorgManager_CheckReorg_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*entities.L1Block), args[1].(*types.Block))
	})
	return _c
}
...
func (_c *ReorgManager_CheckReorg_Call) RunAndReturn(run func(*entities.L1Block, *types.Block) (*entities.L1Block, uint64, error)) *ReorgManager_CheckReorg_Call {
	_c.Call.Return(run)
	return _c
}
