...
func (_m *EthermanInterface) GetL1BlockByNumber(ctx context.Context, blockNumber uint64) (*types.Block, error) {
...
func (_c *EthermanInterface_GetL1BlockByNumber_Call) Return(_a0 *types.Block, _a1 error) *EthermanInterface_GetL1BlockByNumber_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EthermanInterface_GetL1BlockByNumber_Call) RunAndReturn(run func(context.Context, uint64) (*types.Block, error)) *EthermanInterface_GetL1BlockByNumber_Call {
	_c.Call.Return(run)
	return _c
}

// GetRollupInfoByBlockRange provides a mock function with given fields: ctx, fromBlock, toBlock
func (_m *EthermanInterface) GetRollupInfoByBlockRange(ctx context.Context, fromBlock uint64, toBlock *uint64) ([]types.Block, map[common.Hash][]types.Order, error) {
	...
	var r0 []types.Block
	var r1 map[common.Hash][]types.Order
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, *uint64) ([]types.Block, map[common.Hash][]types.Order, error)); ok {
		return rf(ctx, fromBlock, toBlock)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, *uint64) []types.Block); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, uint64, *uint64) map[common.Hash][]types.Order); ok {
		r1 = rf(ctx, fromBlock, toBlock)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(map[common.Hash][]types.Order)
		}
	}
...
func (_c *EthermanInterface_GetRollupInfoByBlockRange_Call) Return(_a0 []types.Block, _a1 map[common.Hash][]types.Order, _a2 error) *EthermanInterface_GetRollupInfoByBlockRange_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *EthermanInterface_GetRollupInfoByBlockRange_Call) RunAndReturn(run func(context.Context, uint64, *uint64) ([]types.Block, map[common.Hash][]types.Order, error)) *EthermanInterface_GetRollupInfoByBlockRange_Call {
	_c.Call.Return(run)
	return _c
}
