...
func (_m *StatePreCheckInterfacer) GetUncheckedBlocks(ctx context.Context, fromBlockNumber uint64, toBlockNumber uint64, dbTx pgx.Tx) ([]*l1_check_block.L1Block, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, pgx.Tx) ([]*l1_check_block.L1Block, error)); ok {
		return rf(ctx, fromBlockNumber, toBlockNumber, dbTx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uint64, uint64, pgx.Tx) []*l1_check_block.L1Block); ok {
...
func (_c *StatePreCheckInterfacer_GetUncheckedBlocks_Call) Return(_a0 []*l1_check_block.L1Block, _a1 error) *StatePreCheckInterfacer_GetUncheckedBlocks_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StatePreCheckInterfacer_GetUncheckedBlocks_Call) RunAndReturn(run func(context.Context, uint64, uint64, pgx.Tx) ([]*l1_check_block.L1Block, error)) *StatePreCheckInterfacer_GetUncheckedBlocks_Call {
	_c.Call.Return(run)
	return _c
}
