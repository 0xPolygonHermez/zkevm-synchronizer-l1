...
func (_m *AsyncL1BlockChecker) GetResult() *l1_check_block.IterationResult {
	...
	var r0 *l1_check_block.IterationResult
	if rf, ok := ret.Get(0).(func() *l1_check_block.IterationResult); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*l1_check_block.IterationResult)
		}
	}
...
func (_c *AsyncL1BlockChecker_GetResult_Call) Return(_a0 *l1_check_block.IterationResult) *AsyncL1BlockChecker_GetResult_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AsyncL1BlockChecker_GetResult_Call) RunAndReturn(run func() *l1_check_block.IterationResult) *AsyncL1BlockChecker_GetResult_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *AsyncL1BlockChecker) RunSynchronous(ctx context.Context) l1_check_block.IterationResult {
	ret := _m.Called(ctx)
	...
	var r0 l1_check_block.IterationResult
	if rf, ok := ret.Get(0).(func(context.Context) l1_check_block.IterationResult); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(l1_check_block.IterationResult)
	}
...
func (_c *AsyncL1BlockChecker_RunSynchronous_Call) Return(_a0 l1_check_block.IterationResult) *AsyncL1BlockChecker_RunSynchronous_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *AsyncL1BlockChecker_RunSynchronous_Call) RunAndReturn(run func(context.Context) l1_check_block.IterationResult) *AsyncL1BlockChecker_RunSynchronous_Call {
	_c.Call.Return(run)
	return _c
}
