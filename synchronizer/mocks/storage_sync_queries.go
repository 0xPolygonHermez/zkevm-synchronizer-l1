...
func (_m *storageSyncQueries) GetPreviousBlock(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx) (*entities.L1Block, error) {
...
//   - fromBlockNumber *uint64
//   - dbTx entities.Tx
func (_e *storageSyncQueries_Expecter) GetPreviousBlock(ctx interface{}, offset interface{}, fromBlockNumber interface{}, dbTx interface{}) *storageSyncQueries_GetPreviousBlock_Call {
	return &storageSyncQueries_GetPreviousBlock_Call{Call: _e.mock.On("GetPreviousBlock", ctx, offset, fromBlockNumber, dbTx)}
}

func (_c *storageSyncQueries_GetPreviousBlock_Call) Run(run func(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx)) *storageSyncQueries_GetPreviousBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *storageSyncQueries_GetPreviousBlock_Call) RunAndReturn(run func(context.Context, uint64, *uint64, entities.Tx) (*entities.L1Block, error)) *storageSyncQueries_GetPreviousBlock_Call {
	_c.Call.Return(run)
	return _c
}
