...
func (_m *StorageInterface) AddBlock(ctx context.Context, block *entities.L1Block, dbTx entities.Tx) error {
...
func (_c *StorageInterface_AddBlock_Call) Run(run func(ctx context.Context, block *entities.L1Block, dbTx entities.Tx)) *StorageInterface_AddBlock_Call {
...
func (_c *StorageInterface_AddBlock_Call) RunAndReturn(run func(context.Context, *entities.L1Block, entities.Tx) error) *StorageInterface_AddBlock_Call {
	_c.Call.Return(run)
	return _c
}

// AddForkID provides a mock function with given fields: ctx, forkID, dbTx
func (_m *StorageInterface) AddForkID(ctx context.Context, forkID entities.ForkIDInterval, dbTx entities.Tx) error {
...
func (_c *StorageInterface_AddForkID_Call) Run(run func(ctx context.Context, forkID entities.ForkIDInterval, dbTx entities.Tx)) *StorageInterface_AddForkID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_AddForkID_Call) RunAndReturn(run func(context.Context, entities.ForkIDInterval, entities.Tx) error) *StorageInterface_AddForkID_Call {
	_c.Call.Return(run)
	return _c
}

// AddL1InfoTreeLeaf provides a mock function with given fields: ctx, exitRoot, dbTx
func (_m *StorageInterface) AddL1InfoTreeLeaf(ctx context.Context, exitRoot *entities.L1InfoTreeLeaf, dbTx entities.Tx) error {
...
func (_c *StorageInterface_AddL1InfoTreeLeaf_Call) Run(run func(ctx context.Context, exitRoot *entities.L1InfoTreeLeaf, dbTx entities.Tx)) *StorageInterface_AddL1InfoTreeLeaf_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_AddL1InfoTreeLeaf_Call) RunAndReturn(run func(context.Context, *entities.L1InfoTreeLeaf, entities.Tx) error) *StorageInterface_AddL1InfoTreeLeaf_Call {
	_c.Call.Return(run)
	return _c
}

// AddSequencedBatches provides a mock function with given fields: ctx, sequence, dbTx
func (_m *StorageInterface) AddSequencedBatches(ctx context.Context, sequence *entities.SequencedBatches, dbTx entities.Tx) error {
...
func (_c *StorageInterface_AddSequencedBatches_Call) Run(run func(ctx context.Context, sequence *entities.SequencedBatches, dbTx entities.Tx)) *StorageInterface_AddSequencedBatches_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_AddSequencedBatches_Call) RunAndReturn(run func(context.Context, *entities.SequencedBatches, entities.Tx) error) *StorageInterface_AddSequencedBatches_Call {
	_c.Call.Return(run)
	return _c
}

// GetAllL1InfoTreeLeaves provides a mock function with given fields: ctx, dbTx
func (_m *StorageInterface) GetAllL1InfoTreeLeaves(ctx context.Context, dbTx entities.Tx) ([]entities.L1InfoTreeLeaf, error) {
...
func (_c *StorageInterface_GetAllL1InfoTreeLeaves_Call) Run(run func(ctx context.Context, dbTx entities.Tx)) *StorageInterface_GetAllL1InfoTreeLeaves_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_GetAllL1InfoTreeLeaves_Call) Return(_a0 []entities.L1InfoTreeLeaf, _a1 error) *StorageInterface_GetAllL1InfoTreeLeaves_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetAllL1InfoTreeLeaves_Call) RunAndReturn(run func(context.Context, entities.Tx) ([]entities.L1InfoTreeLeaf, error)) *StorageInterface_GetAllL1InfoTreeLeaves_Call {
	_c.Call.Return(run)
	return _c
}

// GetBlockByNumber provides a mock function with given fields: ctx, blockNumber, dbTx
func (_m *StorageInterface) GetBlockByNumber(ctx context.Context, blockNumber uint64, dbTx entities.Tx) (*entities.L1Block, error) {
...
// StorageInterface_GetBlockByNumber_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetBlockByNumber'
type StorageInterface_GetBlockByNumber_Call struct {
	*mock.Call
}
...
//   - blockNumber uint64
//   - dbTx entities.Tx
func (_e *StorageInterface_Expecter) GetBlockByNumber(ctx interface{}, blockNumber interface{}, dbTx interface{}) *StorageInterface_GetBlockByNumber_Call {
	return &StorageInterface_GetBlockByNumber_Call{Call: _e.mock.On("GetBlockByNumber", ctx, blockNumber, dbTx)}
}

func (_c *StorageInterface_GetBlockByNumber_Call) Run(run func(ctx context.Context, blockNumber uint64, dbTx entities.Tx)) *StorageInterface_GetBlockByNumber_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_GetBlockByNumber_Call) Return(_a0 *entities.L1Block, _a1 error) *StorageInterface_GetBlockByNumber_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetBlockByNumber_Call) RunAndReturn(run func(context.Context, uint64, entities.Tx) (*entities.L1Block, error)) *StorageInterface_GetBlockByNumber_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *StorageInterface_GetForkIDs_Call) Run(run func(ctx context.Context, dbTx entities.Tx)) *StorageInterface_GetForkIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.Tx))
	})
	return _c
...
func (_c *StorageInterface_GetForkIDs_Call) Return(_a0 []entities.ForkIDInterval, _a1 error) *StorageInterface_GetForkIDs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetForkIDs_Call) RunAndReturn(run func(context.Context, entities.Tx) ([]entities.ForkIDInterval, error)) *StorageInterface_GetForkIDs_Call {
	_c.Call.Return(run)
	return _c
}

// GetL1InfoLeafPerIndex provides a mock function with given fields: ctx, L1InfoTreeIndex, dbTx
func (_m *StorageInterface) GetL1InfoLeafPerIndex(ctx context.Context, L1InfoTreeIndex uint32, dbTx entities.Tx) (*entities.L1InfoTreeLeaf, error) {
...
func (_c *StorageInterface_GetL1InfoLeafPerIndex_Call) Run(run func(ctx context.Context, L1InfoTreeIndex uint32, dbTx entities.Tx)) *StorageInterface_GetL1InfoLeafPerIndex_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_GetL1InfoLeafPerIndex_Call) Return(_a0 *entities.L1InfoTreeLeaf, _a1 error) *StorageInterface_GetL1InfoLeafPerIndex_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetL1InfoLeafPerIndex_Call) RunAndReturn(run func(context.Context, uint32, entities.Tx) (*entities.L1InfoTreeLeaf, error)) *StorageInterface_GetL1InfoLeafPerIndex_Call {
	_c.Call.Return(run)
	return _c
}

// GetLastBlock provides a mock function with given fields: ctx, dbTx
func (_m *StorageInterface) GetLastBlock(ctx context.Context, dbTx entities.Tx) (*entities.L1Block, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_c *StorageInterface_GetLastBlock_Call) Run(run func(ctx context.Context, dbTx entities.Tx)) *StorageInterface_GetLastBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.Tx))
	})
	return _c
...
func (_c *StorageInterface_GetLastBlock_Call) Return(_a0 *entities.L1Block, _a1 error) *StorageInterface_GetLastBlock_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetLastBlock_Call) RunAndReturn(run func(context.Context, entities.Tx) (*entities.L1Block, error)) *StorageInterface_GetLastBlock_Call {
	_c.Call.Return(run)
	return _c
}

// GetLatestL1InfoTreeLeaf provides a mock function with given fields: ctx, dbTx
func (_m *StorageInterface) GetLatestL1InfoTreeLeaf(ctx context.Context, dbTx entities.Tx) (*entities.L1InfoTreeLeaf, error) {
	ret := _m.Called(ctx, dbTx)
...
func (_c *StorageInterface_GetLatestL1InfoTreeLeaf_Call) Run(run func(ctx context.Context, dbTx entities.Tx)) *StorageInterface_GetLatestL1InfoTreeLeaf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.Tx))
	})
	return _c
...
func (_c *StorageInterface_GetLatestL1InfoTreeLeaf_Call) Return(_a0 *entities.L1InfoTreeLeaf, _a1 error) *StorageInterface_GetLatestL1InfoTreeLeaf_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetLatestL1InfoTreeLeaf_Call) RunAndReturn(run func(context.Context, entities.Tx) (*entities.L1InfoTreeLeaf, error)) *StorageInterface_GetLatestL1InfoTreeLeaf_Call {
	_c.Call.Return(run)
	return _c
}

// GetLeafsByL1InfoRoot provides a mock function with given fields: ctx, l1InfoRoot, dbTx
func (_m *StorageInterface) GetLeafsByL1InfoRoot(ctx context.Context, l1InfoRoot common.Hash, dbTx entities.Tx) ([]entities.L1InfoTreeLeaf, error) {
...
func (_c *StorageInterface_GetLeafsByL1InfoRoot_Call) Run(run func(ctx context.Context, l1InfoRoot common.Hash, dbTx entities.Tx)) *StorageInterface_GetLeafsByL1InfoRoot_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_GetLeafsByL1InfoRoot_Call) Return(_a0 []entities.L1InfoTreeLeaf, _a1 error) *StorageInterface_GetLeafsByL1InfoRoot_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetLeafsByL1InfoRoot_Call) RunAndReturn(run func(context.Context, common.Hash, entities.Tx) ([]entities.L1InfoTreeLeaf, error)) *StorageInterface_GetLeafsByL1InfoRoot_Call {
	_c.Call.Return(run)
	return _c
}

// GetPreviousBlock provides a mock function with given fields: ctx, offset, fromBlockNumber, dbTx
func (_m *StorageInterface) GetPreviousBlock(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx) (*entities.L1Block, error) {
...
//   - fromBlockNumber *uint64
//   - dbTx entities.Tx
func (_e *StorageInterface_Expecter) GetPreviousBlock(ctx interface{}, offset interface{}, fromBlockNumber interface{}, dbTx interface{}) *StorageInterface_GetPreviousBlock_Call {
	return &StorageInterface_GetPreviousBlock_Call{Call: _e.mock.On("GetPreviousBlock", ctx, offset, fromBlockNumber, dbTx)}
}

func (_c *StorageInterface_GetPreviousBlock_Call) Run(run func(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx)) *StorageInterface_GetPreviousBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *StorageInterface_GetPreviousBlock_Call) Return(_a0 *entities.L1Block, _a1 error) *StorageInterface_GetPreviousBlock_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *StorageInterface_GetPreviousBlock_Call) RunAndReturn(run func(context.Context, uint64, *uint64, entities.Tx) (*entities.L1Block, error)) *StorageInterface_GetPreviousBlock_Call {
	_c.Call.Return(run)
	return _c
}

// GetSequenceByBatchNumber provides a mock function with given fields: ctx, batchNumber, dbTx
func (_m *StorageInterface) GetSequenceByBatchNumber(ctx context.Context, batchNumber uint64, dbTx entities.Tx) (*entities.SequencedBatches, error) {
...
func (_c *StorageInterface_GetSequenceByBatchNumber_Call) Run(run func(ctx context.Context, batchNumber uint64, dbTx entities.Tx)) *StorageInterface_GetSequenceByBatchNumber_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64), args[2].(entities.Tx))
	})
	return _c
...
func (_c *StorageInterface_GetSequenceByBatchNumber_Call) Return(_a0 *entities.SequencedBatches, _a1 error) *StorageInterface_GetSequenceByBatchNumber_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
...
func (_c *StorageInterface_UpdateForkID_Call) Run(run func(ctx context.Context, forkID entities.ForkIDInterval, dbTx entities.Tx)) *StorageInterface_UpdateForkID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(entities.ForkIDInterval), args[2].(entities.Tx))
	})
	return _c
...
func (_c *StorageInterface_UpdateForkID_Call) RunAndReturn(run func(context.Context, entities.ForkIDInterval, entities.Tx) error) *StorageInterface_UpdateForkID_Call {
	_c.Call.Return(run)
	return _c
}
