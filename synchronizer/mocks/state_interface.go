...
func (_m *StateInterface) GetPreviousBlock(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx) (*entities.L1Block, error) {
...
//   - dbTx entities.Tx
func (_e *StateInterface_Expecter) GetPreviousBlock(ctx interface{}, offset interface{}, fromBlockNumber interface{}, dbTx interface{}) *StateInterface_GetPreviousBlock_Call {
	return &StateInterface_GetPreviousBlock_Call{Call: _e.mock.On("GetPreviousBlock", ctx, offset, fromBlockNumber, dbTx)}
}

func (_c *StateInterface_GetPreviousBlock_Call) Run(run func(ctx context.Context, offset uint64, fromBlockNumber *uint64, dbTx entities.Tx)) *StateInterface_GetPreviousBlock_Call {
	_c.Call.Run(func(args mock.Arguments) {
