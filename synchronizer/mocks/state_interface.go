...
func (_m *stateInterface) BeginStateTransaction(ctx context.Context) (entities.Tx, error) {
	ret := _m.Called(ctx)
...
func (_c *stateInterface_BeginStateTransaction_Call) Return(_a0 entities.Tx, _a1 error) *stateInterface_BeginStateTransaction_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *stateInterface_BeginStateTransaction_Call) RunAndReturn(run func(context.Context) (entities.Tx, error)) *stateInterface_BeginStateTransaction_Call {
	_c.Call.Return(run)
	return _c
}
