...
func (_m *stateForkIdInterface) AddForkID(ctx context.Context, newForkID state.ForkIDInterval, dbTx pgx.Tx) error {
...
func (_c *stateForkIdInterface_AddForkID_Call) Run(run func(ctx context.Context, newForkID state.ForkIDInterval, dbTx pgx.Tx)) *stateForkIdInterface_AddForkID_Call {
...
func (_c *stateForkIdInterface_AddForkID_Call) RunAndReturn(run func(context.Context, state.ForkIDInterval, pgx.Tx) error) *stateForkIdInterface_AddForkID_Call {
	_c.Call.Return(run)
	return _c
}
