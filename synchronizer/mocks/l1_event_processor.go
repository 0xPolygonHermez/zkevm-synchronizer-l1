...
func (_m *L1EventProcessor) Process(ctx context.Context, order etherman.Order, l1Block *etherman.Block, dbTx pgx.Tx) error {
...
func (_c *L1EventProcessor_Process_Call) Run(run func(ctx context.Context, order etherman.Order, l1Block *etherman.Block, dbTx pgx.Tx)) *L1EventProcessor_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *L1EventProcessor_Process_Call) RunAndReturn(run func(context.Context, etherman.Order, *etherman.Block, pgx.Tx) error) *L1EventProcessor_Process_Call {
	_c.Call.Return(run)
	return _c
}
