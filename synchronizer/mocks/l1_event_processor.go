...
func (_m *L1EventProcessor) Process(ctx context.Context, order etherman.Order, l1Block *etherman.Block, dbTx entities.Tx) error {
...
//   - dbTx entities.Tx
func (_e *L1EventProcessor_Expecter) Process(ctx interface{}, order interface{}, l1Block interface{}, dbTx interface{}) *L1EventProcessor_Process_Call {
	return &L1EventProcessor_Process_Call{Call: _e.mock.On("Process", ctx, order, l1Block, dbTx)}
}

func (_c *L1EventProcessor_Process_Call) Run(run func(ctx context.Context, order etherman.Order, l1Block *etherman.Block, dbTx entities.Tx)) *L1EventProcessor_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *L1EventProcessor_Process_Call) RunAndReturn(run func(context.Context, etherman.Order, *etherman.Block, entities.Tx) error) *L1EventProcessor_Process_Call {
	_c.Call.Return(run)
	return _c
}
