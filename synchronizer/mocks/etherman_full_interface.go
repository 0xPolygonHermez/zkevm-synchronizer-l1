...
// EthermanFullInterface_GetL1BlockByNumber_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetL1BlockByNumber'
type EthermanFullInterface_GetL1BlockByNumber_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - blockNumber uint64
func (_e *EthermanFullInterface_Expecter) GetL1BlockByNumber(ctx interface{}, blockNumber interface{}) *EthermanFullInterface_GetL1BlockByNumber_Call {
	return &EthermanFullInterface_GetL1BlockByNumber_Call{Call: _e.mock.On("GetL1BlockByNumber", ctx, blockNumber)}
}

func (_c *EthermanFullInterface_GetL1BlockByNumber_Call) Run(run func(ctx context.Context, blockNumber uint64)) *EthermanFullInterface_GetL1BlockByNumber_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uint64))
	})
	return _c
