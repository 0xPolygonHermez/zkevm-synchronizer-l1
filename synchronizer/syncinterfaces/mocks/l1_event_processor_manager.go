...
func (_m *L1EventProcessorManager) Process(ctx context.Context, forkId actions.ForkIdType, order etherman.Order, block *etherman.Block, dbTx entities.Tx) error {
...
func (_c *L1EventProcessorManager_Process_Call) Run(run func(ctx context.Context, forkId actions.ForkIdType, order etherman.Order, block *etherman.Block, dbTx entities.Tx)) *L1EventProcessorManager_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *L1EventProcessorManager_Process_Call) RunAndReturn(run func(context.Context, actions.ForkIdType, etherman.Order, *etherman.Block, entities.Tx) error) *L1EventProcessorManager_Process_Call {
	_c.Call.Return(run)
	return _c
}
