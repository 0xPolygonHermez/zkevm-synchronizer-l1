...
func (_m *L1EventProcessorManager) Get(forkId actions.ForkIdType, event types.EventOrder) actions.L1EventProcessor {
	...
	if rf, ok := ret.Get(0).(func(actions.ForkIdType, types.EventOrder) actions.L1EventProcessor); ok {
		r0 = rf(forkId, event)
	} else {
		if ret.Get(0) != nil {
...
func (_c *L1EventProcessorManager_Get_Call) Run(run func(forkId actions.ForkIdType, event types.EventOrder)) *L1EventProcessorManager_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(actions.ForkIdType), args[1].(types.EventOrder))
	})
	return _c
}
...
func (_c *L1EventProcessorManager_Get_Call) RunAndReturn(run func(actions.ForkIdType, types.EventOrder) actions.L1EventProcessor) *L1EventProcessorManager_Get_Call {
	_c.Call.Return(run)
	return _c
}

// Process provides a mock function with given fields: ctx, forkId, order, block, dbTx
func (_m *L1EventProcessorManager) Process(ctx context.Context, forkId actions.ForkIdType, order types.Order, block *types.Block, dbTx entities.Tx) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, actions.ForkIdType, types.Order, *types.Block, entities.Tx) error); ok {
...
func (_c *L1EventProcessorManager_Process_Call) Run(run func(ctx context.Context, forkId actions.ForkIdType, order types.Order, block *types.Block, dbTx entities.Tx)) *L1EventProcessorManager_Process_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(actions.ForkIdType), args[2].(types.Order), args[3].(*types.Block), args[4].(entities.Tx))
	})
	return _c
}
...
func (_c *L1EventProcessorManager_Process_Call) RunAndReturn(run func(context.Context, actions.ForkIdType, types.Order, *types.Block, entities.Tx) error) *L1EventProcessorManager_Process_Call {
	_c.Call.Return(run)
	return _c
}
