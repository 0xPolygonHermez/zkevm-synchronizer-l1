...
func (_m *BlockRangeProcessor) ProcessBlockRangeSingleDbTx(ctx context.Context, blocks []types.Block, order map[common.Hash][]types.Order, finalizedBlockNumber uint64, storeBlocks syncinterfaces.ProcessBlockRangeL1BlocksMode, dbTx entities.Tx) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []types.Block, map[common.Hash][]types.Order, uint64, syncinterfaces.ProcessBlockRangeL1BlocksMode, entities.Tx) error); ok {
...
func (_c *BlockRangeProcessor_ProcessBlockRangeSingleDbTx_Call) Run(run func(ctx context.Context, blocks []types.Block, order map[common.Hash][]types.Order, finalizedBlockNumber uint64, storeBlocks syncinterfaces.ProcessBlockRangeL1BlocksMode, dbTx entities.Tx)) *BlockRangeProcessor_ProcessBlockRangeSingleDbTx_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]types.Block), args[2].(map[common.Hash][]types.Order), args[3].(uint64), args[4].(syncinterfaces.ProcessBlockRangeL1BlocksMode), args[5].(entities.Tx))
	})
	return _c
}
...
func (_c *BlockRangeProcessor_ProcessBlockRangeSingleDbTx_Call) RunAndReturn(run func(context.Context, []types.Block, map[common.Hash][]types.Order, uint64, syncinterfaces.ProcessBlockRangeL1BlocksMode, entities.Tx) error) *BlockRangeProcessor_ProcessBlockRangeSingleDbTx_Call {
	_c.Call.Return(run)
	return _c
}
